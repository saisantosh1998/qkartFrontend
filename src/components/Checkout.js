    ...
    if(validateRequest(items,addresses)){
      try {
        ...
        if (e.response) {
          ...
          enqueueSnackbar(
            "Could not checkout the order. Check that the backend is running, reachable and returns valid JSON.",
            {
              variant: "error",
            }
          );
      ...
      <Grid container>
        <Grid item xs={12} md={9}>
          <Box className="shipping-container" minHeight="100vh">
            ...
            <Button startIcon={<CreditCard />} onClick={async()=>{
          ...
          <Box className="orderDetails">
            ...
            >
              ...
              <Box
                ...
                paddingY="0.5rem"
              >
                <Typography className="h1">Products</Typography>
                <Typography className="h1">{getTotalItems(items)}</Typography>
              </Box>
              <Box
                display="flex"
                justifyContent="space-between"
                ...
                paddingY="0.5rem"
              >
                <Typography className="h1">Subtotal</Typography>
              ...
              <Box
                ...
                paddingY="0.5rem"
              >
                <Typography className="h1">Shipping Charges</Typography>
                <Typography className="h1">{0}</Typography>
              </Box>
              <Box
                display="flex"
                justifyContent="space-between"
